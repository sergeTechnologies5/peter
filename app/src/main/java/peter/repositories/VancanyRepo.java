...
public class VancanyRepo {
    private VacancyDao noteDao;
    ...
    public VancanyRepo(final Application application) {
        Db database = Db.getInstance(application);
        noteDao = database.vacancyDao();
        allNotes = noteDao.getAllVacancies();

        apiInterface = ApiClient.getClient().create(ApiInterface.class);

        Call<List<Vacancy>> call = apiInterface.getVacanciesbyType("job");
    ...
    public LiveData<List<Vacancy>> getAllHomes() {
        return allNotes;
    }
